...
const EmptyCart = () => {
  return (
    <div className="W-11/12  flex flex-col items-center justify-center gap-8 rounded-xl border border-gray-300 p-4">
      <img className="w-56" src={emptyCart} alt="سبد شما خالی است"></img>
      <p className="text-lg text-gray-600">سبد شما خالی است :(</p>
      <Link to="/">
