    ...
    <>
      <div style={{ display: showModal ? "block" : "none" }}>
        <div
          ...
          onClick={renderModal}
        ></div>
        <div className="absolute fadeShow right-0 top-0 z-[101] mr-8 mt-16 flex h-36 flex-col items-center justify-between gap-4 rounded-2xl dark:bg-gray-700 bg-white px-10 py-6 lg:mr-[33rem] lg:mt-24">
      ...
      <div className="group/submitBtn dark:bg-transparent lg:cursor-pointer relative z-[1] flex items-center justify-center gap-2 rounded-full border border-gray-400 bg-white p-2 dark:border-2 dark:border-violet-500 text-sm text-gray-800">
