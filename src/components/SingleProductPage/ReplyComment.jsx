  ...
  return (
    <>
      ...
      <div
        className={`${
          show ? "block" : "hidden"
        } absolute right-0 top-0 z-[1500] flex w-full flex-col items-start justify-start  gap-4 bg-white p-4 lg:right-[25%] lg:top-[170px] lg:w-2/4 lg:max-w-[1360px]  lg:rounded-md`}
      >
