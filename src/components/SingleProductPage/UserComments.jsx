...
const Comment = ({ comment }) => {
  ...
  return (
    <div className="flex w-full flex-col items-start justify-center gap-5 rounded-lg border-b border-gray-300 bg-gray-50 p-2 pb-10 lg:gap-2 lg:border-none lg:shadow-lg">
