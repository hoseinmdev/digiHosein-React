  ...
  return (
    <SiteLayout>
      <div className="flex w-full flex-col items-start justify-center gap-4 p-4 lg:flex-row lg:justify-between">
        ...
        <div className="sticky top-[160px] mr-4 hidden w-72 flex-col items-start justify-center gap-2 rounded-2xl bg-white dark:bg-gray-700 p-2 shadow-lg lg:flex">
        ...
        <div className="flex min-h-[28rem] w-full flex-col flex-wrap items-start justify-start gap-4 rounded-2xl dark:border-none  border border-gray-300 p-4 dark:bg-gray-700/50 lg:w-[65rem] lg:p-6">
